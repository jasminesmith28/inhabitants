 ...
 *
 * @package   Inhabitant_Buisness_Hour
 * @author    Jasmine Smith <jasmine.smith28@outlook.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2015 Your Name or Company Name
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitant Buisness Hours Widget
 * Plugin URI:        https://www.redacademy.com/INhabi
 * Description:       Widget for Buisness Hours
 * Version:           1.0.0
...
class Inhabitant_Buisness_Hour extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'inhabitant-buisness-hour';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'Inhabitant_Buisness_Hour',
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => 'Add the stores buisness hours'
			)
		);
...
add_action( 'widgets_init', function(){
     register_widget( 'Inhabitant_Buisness_Hour' );
});
